...
<html lang="es">
<head>
    <title>Tienda Harnina: update daper</title>
    <meta charset="utf-8">
...
<div class="contenido01">
    <form enctype="multipart/form-data" id="client_register" method="GET" action="/valiCliUpdateDaper">
        <div class="menu s3 caja03">
            <h4>Update data person Client</h4>
            ...
            <div id="div_clientCP">
                ...
                <input class="etiqueta s8" id="clientCP" name="codigoPostalCliente" value="<%=session.getAttribute("codigoPostalCliente") %>" type="text" data-functioncallback="ValidacionExpresionRegular.validarCodigoPostal" required placeholder="input your cp" title="5 characters">
            </div>
...
<script src="../js/jsStore/clienteStrategyAll.js"></script>