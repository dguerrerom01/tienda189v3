package prueba.pool4.pool5;

import java.sql.*;
import java.util.UUID;

public class H2BatchProcessing {
    ...
    public void getConnection(){
        try {
            ...
            connection = DriverManager.getConnection("jdbc:h2:~/empresa189", "SA", ""); // "jdbc:h2:tienda189",
    ...
    public static void main(String[] args) {
        H2BatchProcessing batchProcessing = new H2BatchProcessing();
